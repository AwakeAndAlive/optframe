    ...
    with open(csv_file, newline='') as csvfile:
        ...
        with open(sql_file, 'w') as sqlfile:
            ...
            for row in reader:
                ...
                best_solution = row[5]
                sql = f"INSERT INTO tsp_sa_data (instance, initial_evaluation, best_evaluation, improvement, execution_time, best_solution, source) VALUES ('{instance}', {initial_evaluation}, {best_evaluation}, {improvement}, {execution_time}, '{best_solution}', 'C');\n"
                sqlfile.write(sql)
